...
def main():
    ...
    input_batches, target_batches = create_batches(tokens, word_to_idx, batch_size=128, seq_length=30)
    ...
    # 6. Generate text
    generated_text = generate_text(model, idx_to_word, word_to_idx, initial_text="the", max_length=50)
